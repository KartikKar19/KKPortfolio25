      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <motion.button
            ...
            className="cursor-target bg-green-600 hover:bg-green-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-green-600/25 border border-green-500 text-sm sm:text-base"
          >
            View My Work
          </motion.button>
          <motion.a
            ...
            download
            className="cursor-target flex items-center justify-center space-x-2 border-2 border-gray-600 hover:border-green-400 text-gray-300 hover:text-green-400 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold transition-all duration-200 hover:bg-gray-800/50 text-sm sm:text-base"
          >
            <Download size={20} />
        ...
        >
          <motion.a
            ...
            className="cursor-target flex items-center justify-center space-x-2 text-gray-300 hover:text-green-400 transition-colors duration-200 bg-gray-800/50 px-4 py-2 rounded-lg border border-gray-700 hover:border-green-400"
          >
            <Github size={24} />
